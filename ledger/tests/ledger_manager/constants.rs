...
pub const EMULATOR_HOME: &[&str] = &[
    EMULATOR_SUI_TEXT,
    EMULATOR_SETTINGS_TEXT,
    EMULATOR_QUIT_TEXT,
];
...
pub const EMULATOR_SETTINGS: &[&str] = &[
    EMULATOR_ENABLED_TEXT,
    EMULATOR_DISABLED_TEXT,
    EMULATOR_BACK_TEXT,
];
...
pub const EMULATOR_SIGN: &[&str] = &[
    EMULATOR_ACCEPT_TEXT,
    EMULATOR_NOT_RECOGNIZED_TEXT,
    EMULATOR_REJECT_TEXT,
];
